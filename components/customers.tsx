...
export default function Customers() {
  ...
  return (
    <section className="w-full px-4 py-16 md:py-24 bg-gradient-to-br from-neutral-50 to-neutral-100">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <p className="text-6xl md:text-8xl font-bold text-primary">
              <CountUp from={0} to={20} duration={2} />
              <span className="text-primary">
                <LineShadowText className="italic" shadowColor={"black"}>+</LineShadowText>
              </span>
            </p>
            <p className="text-xl md:text-2xl mt-2 text-neutral-700 tracking-widest">
              Vehicles Available
            </p>
          </div>
